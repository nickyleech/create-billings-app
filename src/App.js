...
import { Copy, Check, LogOut, User, BarChart3, Sliders, Palette, Layers, Download, ChevronDown } from 'lucide-react';
...
const MainApp = () => {
  ...
  // Modal states for advanced billing
...
Your entire response must be valid JSON only. Do not include any other text or formatting.`;
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Advanced Billing Modals - only show when in advanced billing mode */}
      {currentSection === 'billing' && !simpleBillingMode && (
        <>
          <CustomLimitsModal
